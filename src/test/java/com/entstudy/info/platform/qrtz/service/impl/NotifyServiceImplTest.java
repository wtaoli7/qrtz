...
public final class NotifyServiceImplTest {

	@Autowired
	private NotifyService service;

	@Test
	public void sendStudentNotifyTest() {
		try {
			GxhAttendenceInfo info = new GxhAttendenceInfo();
			info.setStudentNo("xy-20130309-00001002");
			service.sendParentNotify(info);
		} catch (Exception e) {
